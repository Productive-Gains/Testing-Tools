...
var http = require('http'),
    promise = require('selenium-webdriver');

var proxyHost = process.env.WIREMOCK_HOST,
    proxyPort = process.env.WIREMOCK_PORT;
...
module.exports = function () {
    ...
    /**
     * sets the delay of the whole proxy or a single mapping
